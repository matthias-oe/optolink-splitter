datapoints = {
    ...
    "node_id": "vitocal",
    "beautifier" : {"search"  : ["primaer","sekundaer","rueck","energy", "heating","water", "thermal",  "electric", "kaelte", "kuehl", "ueber", "fluessig"],
                    "replace" : ["primär", "sekundär", "rück", "energie","heizen", "wasser","thermisch","elektrisch", "kälte", "kühl", "über", "flüssig"],
                    },
    "domains": [
        {
            "domain" : "sensor",
            ...
            "poll": [
                ( 15,"aussentemperatur", 0x01c1, 3, "b:0:1", 0.1),                         #WPR3_Aussentemperatur~0x01C1
                ...
                (  1,"fluessiggastemperatur", 0xb404, 3, "b:1:2", 0.1),                    #WPR3_Fluessiggastemperatur~0xB404
                (  1,"verdampfung_soll", 0xb406, 3, "b:1:2", 0.1),                         #WPR3_VERDAMPFUNG_SOLL~0xB406
                (  1,"verdampfung", 0xb407, 3, "b:1:2", 0.1),                              #WPR3_VERDAMPFUNG~0xB407
                (  1,"kondensation", 0xb408, 3, "b:1:2", 0.1),                             #WPR3_KONDENSATION~0xB408
                (  1,"sauggas", 0xb409, 3, "b:1:2", 0.1),                                  #WPR3_SAUGGAS~0xB409
                (  1,"heissgas", 0xb40a, 3, "b:1:2", 0.1),                                 #WPR3_HEISSGAS~0xB40A
                (  1,"ueberhitzung_soll", 0xb40b, 3, "b:1:2", 0.1),                        #WPR3_UEBERHITZUNG_SOLL~0xB40B
                (  1,"ueberhitzung_ist", 0xb40c, 3, "b:1:2", 0.1),                         #WPR3_UEBERHITZUNG_IST~0xB40C
                (  1,"delta_unterkuehlung", 0xb40d, 3, "b:1:2", 0.1),                      #WPR3_DELTA_UNTERKUEHLUNG~0xB40D
            ]
        },  
        {
            "domain" : "sensor",
            ...
            "suggested_display_precision": 1,
            "poll": [
                (  1,"sauggasdruck", 0xb410, 3, "b:1:2", 0.1),                             #WPR3_B410_Sauggasdruck~0xB410
                (  1,"heissgasdruck", 0xb411, 3, "b:1:2", 0.1),                            #WPR3_B411_Heissgasdruck~0xB411
            ]
        },
        {
            "domain" : "number",
        ...
        },
        {
            ...
            "poll": [
                ...
                (  0,"anlagenschema", 0x7000, 1, 1),                                       #WPR_Anlagenkonfig_Anlagenschema~0x7000 0: WW,1: 1 HK,2: 1 HK WW,3: 0 HK 1 MHK,4: 0 HK 1 MHK WW,5: 1 HK 1 MHK,6: 1 HK 1 MHK WW,7: 0 HK 1 MHK 1 MHK,8: 0 HK 1 MHK 1 MHK WW,9: 1 HK 1 MHK 1 MHK,10: 1 HK 1 MHK 1 MHK WW,11: Fremdansteuerung
           ]
        },
        {
            "domain" : "sensor",
        ...
        },
        {
            ...
            "poll": [
                ...
                (  1,"leistung_verdichter", 0xb423, 2, "b:1:1", 1),                        #WPR3_B423_Leistung_Verdichter~0xB423
            ]
        },
        {
            "domain" : "sensor",
            ...
            "suggested_display_precision": 0,
            "poll": [
                (  0,"verdichterleistung", 0x5030, 1, 1),                                  #WPR_Verdichter1_LeistungVerd~0x5030
            ]
        },    
        {
            "domain" : "sensor",
        ...
        },
        {
            ...
            "poll": [
                (  1,"verdichterstatus", 0x0480, 1, 1),                                    # 0=Aus,1=Ein Zeigt den Status des Relais an.
                ...
                (  1,"speicherladepumpe", 0x0496, 1, 1),                                   #WPR_RelaisStatus_Speicherladepumpe~0x0496
                (  1,"ausgang_kaeltekreisumkehr", 0xb444, 1, 1),                           #WPR3_B444_Ausgang_Kaeltekreisumkehr~0xB444
             ]
        },        
    ]
}

def extract_poll_items(datapoints):
    poll_items = []
    if "domains" in datapoints:
        for config in datapoints["domains"]:
            if "poll" in config:
                poll_items.extend(config["poll"])
    return poll_items

poll_items = extract_poll_items(datapoints)
